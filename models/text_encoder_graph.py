...
class TextEncoderGraphCache:
    ...
    def __call__(
        ...
        with self._lock:
            ...
            if record is None:
                # Even after warmup freeze, allow capturing new shapes on demand
                # (needed for voice-clone / ref-editing where prompt+text exceeds
                # the warmup buckets). Capture a fresh graph for this key.
